...
const SEED_POSTS: DiningPost[] = [
    ...
    },
    {
        id: 'plan_kannur_1',
        hostId: 'don',
        title: 'Authentic Thalassery Biryani 🍗',
        cuisineTypes: ['Indian', 'Malabar'],
        area: 'Thalassery',
        city: 'Kannur',
        restaurantName: 'Paris Restaurant',
        location: { latitude: 11.7533, longitude: 75.4933 },
        minGroupSize: 2,
        maxGroupSize: 5,
        currentParticipants: 1,
        ...
        visibility: 'public',
        status: 'open',
        description: 'Join me for the original Thalassery dum biryani experience. The aroma is unbeatable!',
        autoApprove: true,
    ...
    },
    {
        id: 'plan_munnar_1',
        hostId: 'swalih',
        title: 'Hillside Cafe Breakfast ☕',
        cuisineTypes: ['Cafe', 'Continental'],
        area: 'Munnar Town',
        city: 'Munnar',
        restaurantName: 'Tea Tales Cafe',
        ...
        visibility: 'public',
        status: 'open',
        description: 'Fresh pastries and local tea with a stunning view of the tea gardens.',
        autoApprove: true,
    ...
    },
    {
        id: 'plan_thrissur_1',
        hostId: 'viknesh',
        title: 'Thrissur Pooram Special Sadya 🥥',
        cuisineTypes: ['Kerala', 'Vegetarian'],
        area: 'Round South',
        city: 'Thrissur',
        restaurantName: 'Bharat Hotel',
        location: { latitude: 10.5276, longitude: 76.2144 },
        minGroupSize: 3,
        maxGroupSize: 10,
        currentParticipants: 1,
        ...
        visibility: 'public',
        status: 'open',
        description: 'Authentic Kerala Sadya served on a plantain leaf with over 20 side dishes!',
        autoApprove: false,
        expiresAt: daysFromNow(9),
        createdAt: new Date(),
        imageURL: 'https://images.unsplash.com/photo-1626082895617-2c6ad3ed28e7?auto=format&fit=crop&w=800&q=80',
        participants: [{ id: 'viknesh', name: 'Viknesh', age: 23, gender: 'Male' }]
    }
];
